...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Card.keywords'
        db.add_column('cards_card', 'keywords', self.gf('foundation.fields.JSONField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Card.rows'
        db.add_column('cards_card', 'rows', self.gf('foundation.fields.JSONField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Card.keywords'
        db.delete_column('cards_card', 'keywords')
