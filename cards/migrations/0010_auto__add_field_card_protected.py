...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Card.protected'
        db.add_column('cards_card', 'protected', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Card.protected'
        db.delete_column('cards_card', 'protected')
