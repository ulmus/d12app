...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Card.rows'
        db.alter_column('cards_card', 'rows', self.gf('foundation.fields.JSONField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Card.rows'
        db.alter_column('cards_card', 'rows', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        'cards.card': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rows': ('foundation.fields.JSONField', [], {'null': 'True', 'blank': 'True'}),
