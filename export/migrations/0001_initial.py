...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('export_printout', (
            ...
            ('html_head', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('header', self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True)),
            ('footer', self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(default='Export', max_length=200, null=True, blank=True)),
            ('filename', self.gf('django.db.models.fields.CharField')(default='export.pdf', max_length=200)),
        ))
        db.send_create_signal('export', ['Printout'])


    def backwards(self, orm):
        
        # Deleting model 'Printout'
        db.delete_table('export_printout')
